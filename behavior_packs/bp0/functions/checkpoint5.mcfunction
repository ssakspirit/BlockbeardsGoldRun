...
scoreboard players operation min_tens cp5 = @e[tag=main] tick_min_tens 
scoreboard players operation min_ones cp5 = @e[tag=main] tick_min_ones
scoreboard players operation sec_tens cp5 = @e[tag=main] tick_sec_tens 
scoreboard players operation sec_ones cp5 = @e[tag=main] tick_sec_ones
scoreboard players operation ms_tens cp5 = @e[tag=main] tick_ms_tens 
scoreboard players operation ms_ones cp5 = @e[tag=main] tick_ms_ones
