...
scoreboard players operation min_tens cp9 = @e[tag=main] tick_min_tens 
scoreboard players operation min_ones cp9 = @e[tag=main] tick_min_ones
scoreboard players operation sec_tens cp9 = @e[tag=main] tick_sec_tens 
scoreboard players operation sec_ones cp9 = @e[tag=main] tick_sec_ones
scoreboard players operation ms_tens cp9 = @e[tag=main] tick_ms_tens 
scoreboard players operation ms_ones cp9 = @e[tag=main] tick_ms_ones
...
scoreboard players set @e[tag=main] checkpoint 10
spawnpoint @a -74 39 34
schedule on_area_loaded add 55 41 -109 55 41 -109 schedules/loadcp10
tag @a add reached_cp9