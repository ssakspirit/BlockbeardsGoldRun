...
scoreboard players operation min_tens cp11 = @e[tag=main] tick_min_tens 
scoreboard players operation min_ones cp11 = @e[tag=main] tick_min_ones
scoreboard players operation sec_tens cp11 = @e[tag=main] tick_sec_tens 
scoreboard players operation sec_ones cp11 = @e[tag=main] tick_sec_ones
scoreboard players operation ms_tens cp11 = @e[tag=main] tick_ms_tens 
scoreboard players operation ms_ones cp11 = @e[tag=main] tick_ms_ones
...
scoreboard players set @e[tag=main] checkpoint 12
spawnpoint @a 96 49 -114
schedule on_area_loaded add 180 73 -84 180 73 -84 schedules/loadcp12
tag @a add reached_cp11