...
scoreboard players operation min_tens cp4 = @e[tag=main] tick_min_tens 
scoreboard players operation min_ones cp4 = @e[tag=main] tick_min_ones
scoreboard players operation sec_tens cp4 = @e[tag=main] tick_sec_tens 
scoreboard players operation sec_ones cp4 = @e[tag=main] tick_sec_ones
scoreboard players operation ms_tens cp4 = @e[tag=main] tick_ms_tens 
scoreboard players operation ms_ones cp4 = @e[tag=main] tick_ms_ones
...
scoreboard players set @e[tag=main] checkpoint 5
tag @a add reached_cp4
effect @a[tag=reached_cp4] night_vision 20 5 true
spawnpoint @a 133 79 -83
